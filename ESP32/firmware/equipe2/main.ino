// =============================================================
//  firmware/equipe2/main.ino
//  Equipe 2 — Sensores: Temperatura (DHT22) + Chuva (FC-37)
//
...
#define FIREBASE_API_KEY   "SUA_API_KEY_EQUIPE2"
#define FIREBASE_DB_URL    "https://seu-projeto-default-rtdb.equipe2-rtdb.firebaseio.com/"
